...
def Step_Through_Voltages():
    ...
    try:
        ...
        the_dev.ReadAverageVoltage(input_ch, no_reads = 10, loud = True)
        time.sleep(1)
...
def Linear_Sweep_V1():
    ...
    try:
        ...
        the_dev.SingleChannelSweep('A1', v_start, v_end, no_steps, v_fixed) # use channel A1 to sweep over the voltage interval
...
def Linear_Sweep_V2():
    ...
    try:
        ...
        # I wonder what that could be used for? 
        the_dev.SingleChannelSweep('A0', the_interval, v_fixed = 0.0) # use channel A1 to sweep over the voltage interval
